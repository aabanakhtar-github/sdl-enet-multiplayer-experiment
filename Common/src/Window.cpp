...
bool Window::init(const std::string& name, int w, int h) {
    ...
    window_ = SDL_CreateWindow(name.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, w, h, SDL_WINDOW_SHOWN);
...
void Window::renderTexture(TextureData& tex, Rect* src, FRect* dst, SDL_RendererFlip flip) {
