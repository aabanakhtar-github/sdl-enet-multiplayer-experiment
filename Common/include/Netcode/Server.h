...
public:
  ...
  void sendPacketToPending(const PacketData &packet, std::size_t hash,
                           int channel, bool reliable = false);
  void sendPacketTo(PacketData &packet, std::size_t ID, int channel,
                    bool reliable = false);
  void broadcastPacket(PacketData &packet, int channel, bool reliable = false);
  void broadcastPacketToAllExcept(PacketData &packet, int channel,
                                  std::size_t ID, bool reliable = false);
